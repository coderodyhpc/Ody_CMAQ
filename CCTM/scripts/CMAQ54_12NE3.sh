...
# =====================================================================
  ...
  export STK_GRPS_002=$IN_PTpath/ptegu/stack_groups_ptegu_${STKCASEG}.ncf
  export STK_GRPS_003=$IN_PTpath/othpt/stack_groups_othpt_${STKCASEG}.ncf
  export STK_GRPS_004=$IN_PTpath/ptagfire/stack_groups_ptagfire_${YYYYMMDD}_${STKCASEG}.ncf
  export STK_GRPS_005=$IN_PTpath/ptfire-rx/stack_groups_ptfire-rx_${YYYYMMDD}_${STKCASEG}.ncf
  export STK_GRPS_006=$IN_PTpath/ptfire-wild/stack_groups_ptfire-wild_${YYYYMMDD}_${STKCASEG}.ncf
  export STK_GRPS_007=$IN_PTpath/ptfire_othna/stack_groups_ptfire_othna_${YYYYMMDD}_${STKCASEG}.ncf
  export STK_GRPS_008=$IN_PTpath/pt_oilgas/stack_groups_pt_oilgas_${STKCASEG}.ncf
  export STK_GRPS_009=$IN_PTpath/cmv_c3_12/stack_groups_cmv_c3_12_${STKCASEG}.ncf
  export STK_GRPS_010=$IN_PTpath/cmv_c1c2_12/stack_groups_cmv_c1c2_12_${STKCASEG}.ncf
