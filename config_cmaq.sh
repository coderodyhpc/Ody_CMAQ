...
#>  gfortran compiler............................................................
    gcc)
        ...
        export myFFLAGS="-ffixed-form -ffixed-line-length-132 -finit-character=32 -O3 -march=native -funroll-loops -ftree-vectorize -ftree-loop-if-convert -fallow-argument-mismatch -fallow-invalid-boz"
        export myFRFLAGS="-ffree-form -ffree-line-length-none -finit-character=32 -O3 -march=native -funroll-loops -ftree-vectorize -ftree-loop-if-convert -fallow-argument-mismatch -fallow-invalid-boz"
        export myCFLAGS="-O2"
